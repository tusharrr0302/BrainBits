...
const DeskScene = () => (
	<div className="monitor-wrap">
		<svg className="monitor-svg" viewBox="0 0 420 580" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<text x="58" y="19" fontSize="4.5" fill="#2a3d52" fontFamily="monospace">Dashboard.jsx</text>
			{/* code lines */}
			...
			<text x="242" y="28" fontSize="5" fill="#2a3d52" fontFamily="monospace" letterSpacing="1">TODAY'S ACTIVITY</text>
			<rect x="240" y="32" width="148" height="1" fill="#1e2d3d"/>
			{/* stat cols */}
			<text x="242" y="46" fontSize="12" fontWeight="700" fill="#5cde5c" fontFamily="monospace">214</text>
			<text x="242" y="54" fontSize="4" fill="#2a3d52" fontFamily="monospace" letterSpacing="0.8">GH COMMITS</text>
			<rect x="282" y="36" width="1" height="28" fill="#1e2d3d"/>
			<text x="290" y="46" fontSize="12" fontWeight="700" fill="#20a0c0" fontFamily="monospace">67</text>
			<text x="290" y="54" fontSize="4" fill="#2a3d52" fontFamily="monospace" letterSpacing="0.8">LC SOLVED</text>
			<rect x="330" y="36" width="1" height="28" fill="#1e2d3d"/>
			<text x="338" y="46" fontSize="12" fontWeight="700" fill="#c8d6e5" fontFamily="monospace">61</text>
			<text x="338" y="54" fontSize="4" fill="#2a3d52" fontFamily="monospace" letterSpacing="0.8">DAY STREAK</text>
			...
			{[138,152,166,180,194,208,222,236,250,264,278,292,306].map((y, i) => (
				<text key={i} x="43" y={y} fontSize="4.5" fill="#1e2d3d" fontFamily="monospace" dominantBaseline="middle">{i+1}</text>
			))}
			...
			<text x="274" y="198" fontSize="4.5" fill="#2a3d52" fontFamily="monospace">bash</text>
			<text x="244" y="213" fontSize="5" fill="#5cde5c" fontFamily="monospace">$ npm run dev</text>
			<text x="244" y="224" fontSize="5" fill="#3a5472" fontFamily="monospace">  VITE v5.4.0 ready</text>
			<text x="244" y="235" fontSize="5" fill="#3a5472" fontFamily="monospace">  ➜ localhost:5173</text>
			<text x="244" y="246" fontSize="5" fill="#20a0c0" fontFamily="monospace">  ✓ 142 modules</text>
			<text x="244" y="257" fontSize="5" fill="#5cde5c" fontFamily="monospace">$</text>
			<rect x="252" y="253" width="4" height="7" rx="1" fill="#5cde5c">
				<animate attributeName="opacity" values="1;0;1" dur="1s" repeatCount="indefinite"/>
			</rect>
			<text x="244" y="288" fontSize="3.8" fill="#1e2d3d" fontFamily="monospace">✓ HMR enabled · port 5173</text>
			...
			{[0,1].map(row =>
				Array.from({length: 12}).map((_,col) => (
					<rect key={`r${row}-${col}`} x={112 + col*16} y={369 + row*11} width="12" height="8" rx="1.5" fill="#0f1923" stroke="#1e2d3d" strokeWidth="0.5"/>
				))
			)}
			{/* spacebar */}
				...
				<div className="landing-cols">
					...
					<div className="landing-left">
						...
						<p className="landing-sub">
							Combines AI tools, IDE functionalities, and analytics to enhance
							your learning — free access for all students.
						</p>
